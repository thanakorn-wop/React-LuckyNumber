...
public class ConstantData {
	...
	public static String ERROR_MESSAGE_BAD_REQUEST = "BAD_REQUEST";
	...
	public static String STATUS_CODE_NOT_SUCCESS_00 = "00";
	...
	public static String MESSAGE_BEFORE_VALIDATE ="validate";

...
public interface MonthRepo extends JpaRepository<MonthModal,String>   {
	...
	@Modifying
	@Query(value = " UPDATE month  set jun = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
	void updateMonth6(String money,String id,String years);
	@Modifying
	@Query(value = " UPDATE month  set jul = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
	void updateMonth7(String money,String id,String years);
	@Modifying
	@Query(value = " UPDATE month  set aug = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
	void updateMonth8(String money,String id,String years);
	@Modifying
	@Query(value = " UPDATE month  set sep = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
	void updateMonth9(String money,String id,String years);
	@Modifying
	@Query(value = " UPDATE month  set oct = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
	void updateMonth10(String money,String id,String years);
	@Modifying
	@Query(value = " UPDATE month  set nov = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
	void updateMonth11(String money,String id,String years);
	@Modifying
	@Query(value = " UPDATE month  set decem = ?1 WHERE id = ?2 and years = ?3 ",nativeQuery = true)
